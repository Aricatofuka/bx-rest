import {
  ...
  iBXRestPullConfigGetHttp, iBXRestPullConfigPublicChannelsGet
...
export class BXRestMapPull {
  static get(value: iBXRestPullConfigGetHttp | undefined): iBXRestPullConfigGet | undefined {
    ...
    if(value?.publicChannels) {
      ...
      console.log('Object.entries(value.publicChannels)',       value.publicChannels, Object.entries(value.publicChannels), Object.fromEntries(Object.entries(value.publicChannels).map(([key, val]) => (
        [key,
          {
            ...val,
