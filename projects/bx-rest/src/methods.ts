import {
  ...
  $add,
  $approve,
  $attach, $bizproc, $blogcomment, $blogpost, $calendar, $chat, $commentitem,
  $complete, $copyto,
  $counters, $create,
  $defer,
  $delegate,
  $delete, $department,
  $disapprove, $disk,
  $elapseditem, $element, $event,
  $favorite, $field, $file,
  $files, $folder,
  $get,
  $getaccess, $getchildren,
  $getFields, $getlist, $getmanifest,
  $history, $iblock, $id, $im, $instances, $isactionallowed, $item, $kill,
  $list, $lists, $log, $markdeleted, $moveto, $mute, $nearest,
  $pause, $planner, $rename,
  $renew, $restore, $result, $robot,
  $search, $send, $server, $setOwner,
  $settings, $share, $sonet_group,
  $start,
  $status,
  $task,
  $tasks, $template, $terminate, $time,
  $timeMan, $type,
  $update, $updateAvatar, $updateColor, $updateTitle, $uploadfile, $url,
  $user, $userfield, $workflow
